...
class AdminerTablesFilter {
    function tablesPrint($tables) { ?>
        ...
        <p class="jsonly" style="padding:10px;position: fixed; top: 219px;"><input id="filter-field" autocomplete="off" style="width:140%"><?php echo script("qs('#filter-field').oninput = tablesFilterInput;"); ?>
        <ul id='tables' style="top: 270px !important;">
            <?php
